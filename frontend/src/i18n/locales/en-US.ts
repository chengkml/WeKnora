...
export default {
  ...
  agentTasks: {
    title: 'Task Monitor',
    subtitle: 'Monitor the document “wiki build” tasks WeKnora dispatches to the agent gateway: inspect running and queued tasks, retry failures, and cancel queued or running tasks',
    cardsTitle: 'Task overview',
    detail: {
      open: 'Logs',
      ...
      close: 'Close',
      reload: 'Reload',
      loadFailed: 'Failed to load the execution log',
      loading: 'Loading…',
      noGatewayTask: 'This task has no gateway task, so there is no execution log',
      expand: 'Expand',
      collapse: 'Collapse',
    },
    cards: {
    ...
    filterKeywordPlaceholder: 'Search document name',
    totalChip: '{total} total',
    columns: {
      docName: 'Document',
      knowledgeBase: 'Knowledge base',
      skill: 'Skill',
    ...
    retry: 'Retry',
    cancel: 'Cancel',
    cancelConfirm: 'Cancel this task? It will stop executing immediately.',
    refresh: 'Refresh',
    autoRefresh: 'Auto refresh',
    empty: 'No tasks',
    loadFailed: 'Failed to load tasks, please try again later',
  ...
  mcpManage: {
    subtitle: 'Push the MCP services configured in WeKnora to the agent-gateway execution side, and review what the gateway actually loaded.',
    newService: 'New MCP Service',
    refresh: 'Refresh',
    sync: 'Sync to Agent Gateway',
    syncing: 'Syncing…',
    syncNow: 'Sync now',
    syncSuccess: 'Synced {n} MCP service(s) to the agent-gateway',
    syncFailed: 'Failed to sync to the agent-gateway',
    syncSummary: 'Sync finished: synced {synced} · skipped {skipped} · warnings {warnings}',
    skippedTitle: 'Skipped',
    warningsTitle: 'Warnings',
    gatewayTitle: 'Agent Gateway Status',
    gatewayUrl: 'Gateway URL',
    gatewaySource: 'Config source',
    sourceManaged: 'Managed file (managed)',
    sourceSeed: 'Seed file (seed)',
    sourceUnknown: 'Unknown',
    reachable: 'Reachable',
    unreachable: 'Unreachable',
    gatewayCount: '{n} service(s) loaded on the gateway',
    statusError: 'Failed to load gateway status',
    driftTitle: 'Gateway config differs from WeKnora',
    driftMissing: 'missing {n}',
    driftExtra: '{n} extra on gateway',
    driftMissingTip: 'Enabled in WeKnora but missing on the gateway: {names}',
    driftExtraTip: 'Present on the gateway but deleted or disabled in WeKnora: {names}',
    loading: 'Loading MCP services…',
    emptyTitle: 'No MCP services',
    emptyDesc: 'Click "New MCP Service" in the top-right corner to add your first one.',
    colName: 'Name / description',
    colTransport: 'Transport',
    colTarget: 'Target',
    colEnabled: 'Enabled',
    colGateway: 'Gateway sync',
    colActions: 'Actions',
    enabled: 'Enabled',
    disabled: 'Disabled',
    enable: 'Enable',
    disable: 'Disable',
    enabledToast: 'MCP service enabled',
    disabledToast: 'MCP service disabled',
    toggleFailed: 'Failed to update the MCP service state',
    unnamed: 'Unnamed',
    emptyTarget: 'No URL configured',
    credentialConfigured: 'Credential configured',
    credentialMissing: 'Credential missing',
    credentialTip: 'Only shows whether the secret is configured; plaintext is never displayed.',
    test: 'Test',
    testing: 'Testing…',
    testTitle: 'Test result: {name}',
    testFailed: 'Failed to test the MCP service',
    gatewayTest: 'Gateway-side test',
    gatewayTesting: 'Testing on the gateway…',
    gatewayTestTitle: 'Gateway-side test: {name}',
    gatewayTestFailed: 'Gateway-side test failed',
    gatewayOk: 'Gateway connection OK',
    gatewayFailed: 'Gateway connection failed',
    elapsed: 'took {ms} ms',
    gatewayTransport: 'Gateway transport',
    toolsCount: '{n} tool(s)',
    noTools: 'The gateway returned no tools',
    edit: 'Edit',
    delete: 'Delete',
    deleteConfirm: 'Delete MCP service "{name}"? It will also be removed from the agent-gateway.',
    deleted: 'MCP service deleted',
    deleteFailed: 'Failed to delete the MCP service',
    badgeSynced: 'Synced',
    badgeNotSynced: 'Not synced',
    badgeUnsupported: 'Unsupported',
    badgeDisabled: 'Disabled',
    badgeUnknown: 'Unknown',
    tipSynced: 'Already pushed to the agent-gateway',
    tipNotSynced: 'The service is enabled but not yet on the gateway — click "Sync to Agent Gateway" to fix.',
    tipSseUnsupported: 'The gateway only supports stdio / http-streamable (streamable_http); SSE services are skipped.',
    tipOauthUnsupported: 'OAuth is per-user, so the gateway cannot reuse that token — no auth header is pushed.',
    tipDisabled: 'The service is disabled, so it is not pushed (a same-named entry on the gateway is removed).',
    tipStatusUnknown: 'Gateway status unknown — click "Refresh" first.',
    transport: {
      sse: 'SSE',
  ...
  knowledgeBase: {
    ...
    zipExtractSuccess: 'ZIP extracted, {count} file(s) created',
    zipSkippedType: '{count} file(s) skipped (unsupported format)',
    zipSkippedDuplicate: '{count} file(s) skipped (already exists)',
    zipSkippedOversize: '{count} file(s) skipped (exceeded size limit)',
    zipSkippedDepth: '{count} file(s) skipped (nesting too deep)',
    zipSkippedCount: '{count} file(s) skipped (file count limit exceeded)',
    zipFailed: '{count} file(s) failed to create',
    ...
    uploadFileDesc: 'Supports PDF, Word, TXT, images, audio, ZIP, etc.',
    ...
    wikiBuilding: 'Wiki building…',
    wikiBuildFailed: 'Wiki build failed',
    wikiBuildRetry: 'Retry build',
    wikiBuildCancelled: 'Build cancelled',
    wikiBuildRetrySubmitted: 'Build re-submitted',
    wikiBuildRetryFailed: 'Retry failed. Please try again later',
  ...
  knowledgeStages: {
    ...
    subspan: {
      ...
      'multimodal.image': 'Image understanding',
      'postprocess.summary': 'Content summary',
      'postprocess.question': 'Question generation',
      'postprocess.graph.chunk': 'Knowledge graph extraction',
      'postprocess.wiki': 'Wiki sync',
      'postprocess.wiki.extract': 'Wiki page extraction',
      'postprocess.wiki.summary': 'Wiki summary',
      'postprocess.wiki.classify': 'Wiki classification',
      'postprocess.wiki.page': 'Wiki page',
      'postprocess.question.batch': 'Question generation batch',
      'agent_build_start': 'Skill starts building Wiki',
      'agent_build_relations': 'Lineage/version family resolution',
      'agent_build_dirs': 'Create family/version directories',
      'agent_build_summary': 'Generate document summary',
      'agent_build_entities': 'Extract entities & keywords',
      'agent_build_keywords': 'Extract high-frequency keywords',
      'agent_build_index': 'Rebuild index & links',
      'agent_build_done': 'Skill Wiki build complete',
    },
    status: {
      pending: 'Pending',
      running: 'Running',
      ...
      skipped: 'Skipped',
      cancelled: 'Cancelled',
      agent_running: 'Parsed, skill still building',
      agent_failed: 'Skill build failed',
      agent_cancelled: 'Skill cancelled',
    },
    agent: {
      title: 'Wiki Skill Build',
      total: 'Total {d}',
      noLogs: 'No skill progress logs yet',
      status: {
        queued: 'Skill queued',
  ...
  auth: {
    ...
    emailOptionalPlaceholder: 'Enter email address (optional)',
    userId: 'User ID',
    userIdPlaceholder: 'Enter user ID',
    userIdRequired: 'Enter user ID',
    userIdMinLength: 'User ID must be at least 2 characters',
    userIdMaxLength: 'User ID cannot exceed 50 characters',
    userIdInvalid: 'User ID can only contain letters, numbers, underscores and hyphens',
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      ownershipTypeLabel: 'Knowledge Base Ownership',
      ...
      skillLabel: 'Build Skill',
      skillTip: 'Select the agent skill used for Wiki building (takes effect when custom generation is enabled)',
      skillPlaceholder: 'Select a build skill (default skill applies when empty)',
    ...
    wikiBrowser: {
      ...
      tabMaintenanceTip: 'Review all manual comments and questions across this KB’s Wiki, which can later drive Wiki optimization',
      tabKeywords: 'High-frequency words',
      tabKeywordsTip: 'Words of this KB ranked by frequency; click a frequency for details, click a word to open the page',
      feedbackAddTitle: 'Add comment or question',
      feedbackDialogTitle: 'Add Comment / Question',
      feedbackPageLabel: 'Page',
      feedbackTypeLabel: 'Type',
      feedbackContentLabel: 'Content',
      feedbackContentPlaceholder: 'Type your comment or question…',
      feedbackHint: 'Submitted items are aggregated in the Maintenance tab for later Wiki optimization.',
      feedbackContentRequired: 'Please enter content',
      feedbackSubmitted: 'Feedback submitted',
      feedbackSubmitFailed: 'Failed to submit. Please try again later',
      feedbackQuickTitle: 'Quick feedback',
      feedbackPresetContentError: 'Content error',
      feedbackPresetOutdated: 'Outdated info',
      feedbackPresetBrokenLink: 'Broken link',
      feedbackPresetFormatIssue: 'Format issue',
      feedbackPresetIncomplete: 'Incomplete info',
      feedbackPresetCustom: 'Custom comment / question…',
      feedbackPresetLabel: 'Quick mark',
      feedbackPresetPlaceholder: 'Pick a quick mark (optional)',
      feedbackPresetPreview: 'Will be recorded as: "{label}"',
      ...
      moveToFoldersTitle: 'Move to folders',
      moveToFoldersHint: 'Choose one or more target folders for "{title}" (none selected = move to root)',
      moveToFoldersAction: 'Move to folders',
      moveToFoldersEmpty: 'No folders yet — create one above first',
      ...
      filterBusinessOntology: 'Business Ontology',
      filterRuleOntology: 'Rule Ontology',
      filterOriginalSentence: 'Original Sentences',
      filterFrequentKeyword: 'Frequent Keywords',
      filterTopicCluster: 'Topic Cluster',
      filterKnowledgeGraphSummary: 'Knowledge Graph Summary',
      filterCrossDocumentInsight: 'Cross-Document Insight',
      filterOriginalDocWiki: 'Original Doc Wiki',
      filterClusteredKnowledgeWiki: 'Clustered Knowledge Wiki',
      viewReader: 'Reader',
      viewGraph: 'Graph',
    ...
    wikiKeywords: {
      ...
      totalChip: '{total} words',
      searchPlaceholder: 'Search words',
      sortFreqDesc: 'Frequency: high → low',
      sortFreqAsc: 'Frequency: low → high',
      sortKeywordAsc: 'Word A-Z',
      sortKeywordDesc: 'Word Z-A',
      rank: 'Rank',
      keyword: 'Word',
      meaning: 'Meaning',
      freq: 'Total frequency',
      docCount: 'Documents',
      freqViewTip: 'View details',
      drawerEmpty: 'No content',
      markColumn: 'Mark',
      markAction: 'Mark',
      markTitle: 'Mark keyword',
      markWordLabel: 'Keyword',
      markTypeLabel: 'Mark type',
      markPlaceholder: 'Pick a mark type',
      markContentLabel: 'Note',
      markContentPlaceholder: 'Optional note…',
      markHint: 'Marks are aggregated in the Maintenance tab to judge whether a keyword has real business meaning or was extracted correctly',
      markRequired: 'Pick a mark type or write a note',
      markContentRequired: 'Please enter a note',
      markSubmitted: 'Mark submitted',
      markSubmitFailed: 'Failed to submit. Please try again later',
      presetMeaningful: 'Has business meaning',
      presetNoise: 'No business meaning (noise)',
      presetMisExtracted: 'Incorrectly extracted',
      feedbackPresetCustom: 'Custom comment / question…',
      emptyTitle: 'No high-frequency words yet',
      emptyDesc: 'Word pages are generated automatically after uploading documents and enabling Wiki',
      loadFailed: 'Failed to load. Please try again later',
    },
    wikiMaintenance: {
      title: 'Maintenance Center',
      totalChip: '{total} items',
      ...
      emptyDesc: 'Click the Feedback button on any Wiki page to add a comment or question.',
    ...
    globalSettings: {
      ...
      sections: {
        ...
        userManagement: {
          ...
          description: 'View all users, manage their workspace memberships, and remove user accounts. System administrator only.',
          table: {
            username: 'Username',
            email: 'Email',
            ...
            isActive: 'Active',
            createdAt: 'Created',
            tenants: 'Workspaces ({count})',
            actions: 'Actions',
            noTenants: 'No workspace memberships',
          ...
          deleteUser: {
            ...
            confirmBody: 'Permanently delete user "{username}" ({email})? This action cannot be undone. All data associated with this user will be removed.',
            confirmBtn: 'Delete',
