...
export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      tabKeywords: 'High-frequency keywords',
      tabKeywordsTip: 'Keywords of this KB ranked by frequency, click to open the keyword page',
    ...
    wikiKeywords: {
      ...
      totalChip: '{total} keywords',
      searchPlaceholder: 'Search keywords',
      sortFreqDesc: 'Frequency: high → low',
      sortFreqAsc: 'Frequency: low → high',
      sortKeywordAsc: 'Keyword A-Z',
      sortKeywordDesc: 'Keyword Z-A',
      rank: 'Rank',
      keyword: 'Keyword',
      freq: 'Total frequency',
      docCount: 'Documents',
      emptyTitle: 'No high-frequency keywords yet',
      emptyDesc: 'Keyword pages are generated automatically after uploading documents and enabling Wiki',
