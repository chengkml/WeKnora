export default {
  ...
  agentTasks: {
    title: "작업 모니터",
    subtitle: "WeKnora가 agent-gateway로 전달한 문서 '위키 구축' 작업을 모니터링합니다: 실행 중·대기 중 작업 확인, 실패 작업 재시도, 대기 또는 실행 중 작업 취소",
    cardsTitle: "작업 개요",
    detail: {
      open: "로그",
      title: "작업 실행 로그",
      ...
      close: "닫기",
      reload: "다시 불러오기",
      loadFailed: "실행 로그를 불러오지 못했습니다",
      loading: "불러오는 중…",
      noGatewayTask: "연결된 게이트웨이 작업이 없어 실행 로그를 볼 수 없습니다",
      expand: "펼치기",
      collapse: "접기",
    },
    cards: {
    ...
    filterStatus: "상태별 필터",
    filterKeywordPlaceholder: "문서 이름 검색",
    totalChip: "총 {total}건",
    columns: {
      docName: "문서 이름",
      knowledgeBase: "지식베이스",
    ...
    retry: "재시도",
    cancel: "취소",
    cancelConfirm: "이 작업을 취소하시겠습니까? 즉시 실행이 중단됩니다.",
    refresh: "새로고침",
    autoRefresh: "자동 새로고침",
    empty: "작업이 없습니다",
    loadFailed: "작업 목록을 불러오지 못했습니다. 잠시 후 다시 시도해 주세요",
    actionSucceeded: "{action} 완료",
    actionFailed: "{action} 실패, 잠시 후 다시 시도해 주세요",
    duration: {
      empty: "-",
      seconds: "{n}s",
      minutes: "{m}m{s}s",
  ...
  mcpManage: {
    subtitle: "WeKnora에서 설정한 MCP 서비스를 실행 측 agent-gateway로 내려보내고, 게이트웨이에 실제 반영된 내용을 확인합니다.",
    newService: "MCP 서비스 추가",
    refresh: "새로고침",
    sync: "Agent 게이트웨이로 동기화",
    syncing: "동기화 중…",
    syncNow: "지금 동기화",
    syncSuccess: "MCP 서비스 {n}개를 Agent 게이트웨이로 동기화했습니다",
    syncFailed: "Agent 게이트웨이 동기화에 실패했습니다",
    syncSummary: "동기화 완료: 성공 {synced} · 건너뜀 {skipped} · 경고 {warnings}",
    skippedTitle: "건너뜀",
    warningsTitle: "경고",
    gatewayTitle: "Agent 게이트웨이 상태",
    gatewayUrl: "게이트웨이 주소",
    gatewaySource: "설정 출처",
    sourceManaged: "관리 파일(managed)",
    sourceSeed: "시드 파일(seed)",
    sourceUnknown: "알 수 없음",
    reachable: "연결 가능",
    unreachable: "연결 불가",
    gatewayCount: "게이트웨이에 반영된 서비스 {n}개",
    statusError: "게이트웨이 상태를 가져오지 못했습니다",
    driftTitle: "게이트웨이 설정이 WeKnora와 일치하지 않습니다",
    driftMissing: "{n}개 누락",
    driftExtra: "게이트웨이에 {n}개 초과",
    driftMissingTip: "WeKnora에서 활성화되었지만 게이트웨이에 없는 서비스: {names}",
    driftExtraTip: "게이트웨이에 있지만 WeKnora에서 삭제되거나 비활성화된 서비스: {names}",
    loading: "MCP 서비스 목록을 불러오는 중…",
    emptyTitle: "MCP 서비스가 없습니다",
    emptyDesc: "오른쪽 위 \"MCP 서비스 추가\"를 눌러 첫 서비스를 등록하세요.",
    colName: "이름 / 설명",
    colTransport: "전송 방식",
    colTarget: "대상",
    colEnabled: "활성화",
    colGateway: "게이트웨이 동기화",
    colActions: "작업",
    enabled: "활성화됨",
    disabled: "비활성화됨",
    enable: "활성화",
    disable: "비활성화",
    enabledToast: "MCP 서비스를 활성화했습니다",
    disabledToast: "MCP 서비스를 비활성화했습니다",
    toggleFailed: "MCP 서비스 상태 변경에 실패했습니다",
    unnamed: "이름 없음",
    emptyTarget: "주소 미설정",
    credentialConfigured: "자격 증명 설정됨",
    credentialMissing: "자격 증명 없음",
    credentialTip: "비밀값 설정 여부만 표시하며 평문은 노출하지 않습니다.",
    test: "테스트",
    testing: "테스트 중…",
    testTitle: "테스트 결과: {name}",
    testFailed: "MCP 서비스 테스트에 실패했습니다",
    gatewayTest: "게이트웨이 테스트",
    gatewayTesting: "게이트웨이 테스트 중…",
    gatewayTestTitle: "게이트웨이 테스트: {name}",
    gatewayTestFailed: "게이트웨이 테스트에 실패했습니다",
    gatewayOk: "게이트웨이 연결 성공",
    gatewayFailed: "게이트웨이 연결 실패",
    elapsed: "{ms} ms 소요",
    gatewayTransport: "게이트웨이 전송 방식",
    toolsCount: "도구 {n}개",
    noTools: "게이트웨이가 도구 목록을 반환하지 않았습니다",
    edit: "편집",
    delete: "삭제",
    deleteConfirm: "MCP 서비스 \"{name}\"을(를) 삭제하시겠습니까? agent-gateway에서도 함께 제거됩니다.",
    deleted: "MCP 서비스를 삭제했습니다",
    deleteFailed: "MCP 서비스 삭제에 실패했습니다",
    badgeSynced: "동기화됨",
    badgeNotSynced: "미동기화",
    badgeUnsupported: "지원 안 함",
    badgeDisabled: "비활성",
    badgeUnknown: "알 수 없음",
    tipSynced: "이미 agent-gateway로 전송됨",
    tipNotSynced: "서비스가 활성화되었지만 게이트웨이에 없습니다. \"Agent 게이트웨이로 동기화\"를 눌러 해결하세요.",
    tipSseUnsupported: "게이트웨이는 stdio / http-streamable(streamable_http)만 지원하며 SSE 서비스는 건너뜁니다.",
    tipOauthUnsupported: "OAuth는 사용자별 인증이므로 게이트웨이에서 토큰을 재사용할 수 없어 인증 헤더를 내려보내지 않습니다.",
    tipDisabled: "서비스가 비활성화되어 게이트웨이로 전송되지 않습니다(동일 이름 항목은 제거됩니다).",
    tipStatusUnknown: "게이트웨이 상태를 알 수 없습니다. 먼저 \"새로고침\"을 누르세요.",
    transport: {
      sse: "SSE",
  ...
  knowledgeBase: {
    ...
    zipExtractSuccess: "ZIP 압축 해제 완료, {count}개 파일 생성",
    zipSkippedType: "{count}개 파일 건너뜀 (지원하지 않는 형식)",
    zipSkippedDuplicate: "{count}개 파일 건너뜀 (이미 존재)",
    zipSkippedOversize: "{count}개 파일 건너뜀 (크기 초과)",
    zipSkippedDepth: "{count}개 파일 건너뜀 (중첩 깊이 초과)",
    zipSkippedCount: "{count}개 파일 건너뜀 (파일 수 제한 초과)",
    zipFailed: "{count}개 파일 생성 실패",
    ...
    uploadFile: "파일 업로드",
    uploadFileDesc: "PDF, Word, TXT, 이미지, 오디오, ZIP 등 지원",
    importURL: "웹페이지 가져오기",
    addDocument: "문서 추가",
    ...
    moveProgress: "이동 중...",
    parsingFailed: "파싱 실패",
    wikiBuilding: "Wiki 구축 중…",
    wikiBuildFailed: "Wiki 구축 실패",
    wikiBuildRetry: "구축 재시도",
    wikiBuildCancelled: "구축 취소됨",
    wikiBuildRetrySubmitted: "구축이 다시 제출되었습니다",
    wikiBuildRetryFailed: "재시도 실패. 잠시 후 다시 시도해 주세요",
  ...
  knowledgeStages: {
    ...
    subspan: {
      "embedding.embed": "임베딩",
      "multimodal.image": "이미지 이해",
      "postprocess.summary": "콘텐츠 요약 생성",
      "postprocess.question": "질문 생성",
      "postprocess.graph.chunk": "지식 그래프 추출",
      "postprocess.wiki": "Wiki 동기화",
      "postprocess.wiki.extract": "Wiki 페이지 추출",
      "postprocess.wiki.summary": "Wiki 요약",
      "postprocess.wiki.classify": "Wiki 분류",
      "postprocess.wiki.page": "Wiki 페이지",
      "postprocess.question.batch": "질문 생성 배치",
      "agent_build_start": "스킬 Wiki 빌드 시작",
      "agent_build_relations": "계보/버전 패밀리 해석",
      "agent_build_dirs": "패밀리/버전 디렉터리 생성",
      "agent_build_summary": "문서 요약 생성",
      "agent_build_entities": "엔티티·키워드 추출",
      "agent_build_keywords": "고빈도 키워드 추출",
      "agent_build_index": "인덱스·링크 재구축",
      "agent_build_done": "스킬 Wiki 빌드 완료",
    },
    status: {
      pending: "대기 중",
      running: "진행 중",
      ...
      skipped: "건너뜀",
      cancelled: "취소됨",
      agent_running: "파싱 완료·스킬 빌드 중",
      agent_failed: "스킬 빌드 실패",
      agent_cancelled: "스킬 취소됨",
    },
    agent: {
      title: "Wiki 스킬 빌드",
      total: "총 소요 {d}",
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      skillLabel: "구축 스킬",
      skillTip: "Wiki 구축에 사용할 에이전트 스킬을 선택하세요 (수동 생성 활성화 시 적용)",
      skillPlaceholder: "구축 스킬을 선택하세요 (비어 있으면 기본 스킬 사용)",
      nameLabel: "지식베이스 이름",
    ...
    wikiBrowser: {
      ...
      tabMaintenance: "유지보수",
      tabMaintenanceTip: "이 지식 베이스 Wiki의 사용자 댓글/질문을 모아 확인하고, 이후 Wiki 최적화에 활용합니다.",
      tabKeywords: "핵심 키워드",
      tabKeywordsTip: "빈도순 키워드 목록, 클릭하면 키워드 페이지로 이동합니다",
      feedbackAddTitle: "댓글 또는 질문 추가",
      feedbackDialogTitle: "댓글 / 질문",
      feedbackPageLabel: "페이지",
      feedbackTypeLabel: "유형",
      feedbackContentLabel: "내용",
      feedbackContentPlaceholder: "댓글 또는 질문을 입력하세요…",
      feedbackHint: "제출된 항목은 '유지보수' 탭에 모여 향후 Wiki 최적화에 참고됩니다.",
      feedbackContentRequired: "내용을 입력해 주세요",
      feedbackSubmitted: "의견이 제출되었습니다",
      feedbackSubmitFailed: "제출에 실패했습니다. 잠시 후 다시 시도해 주세요",
      feedbackQuickTitle: "빠른 피드백",
      feedbackPresetContentError: "내용 오류",
      feedbackPresetOutdated: "정보 오래됨",
      feedbackPresetBrokenLink: "링크 오류",
      feedbackPresetFormatIssue: "형식 문제",
      feedbackPresetIncomplete: "정보 불완전",
      feedbackPresetCustom: "직접 작성 / 질문…",
      feedbackPresetLabel: "빠른 표시",
      feedbackPresetPlaceholder: "빠른 표시 선택(선택 사항)",
      feedbackPresetPreview: "「{label}」로 기록됩니다",
      ...
      rootFolderLabel: "루트",
      moveToFoldersTitle: "디렉터리로 이동",
      moveToFoldersHint: "'{title}' 페이지가 속할 디렉터리를 하나 이상 선택하세요 (선택하지 않으면 루트로 이동)",
      moveToFoldersAction: "디렉터리로 이동",
      moveToFoldersEmpty: "디렉터리가 없습니다. 먼저 새 디렉터리를 만드세요",
    ...
    wikiKeywords: {
      title: "핵심 키워드",
      totalChip: "키워드 {total}개",
      searchPlaceholder: "키워드 검색",
      sortFreqDesc: "빈도 내림차순",
      sortFreqAsc: "빈도 오름차순",
      sortKeywordAsc: "이름 A-Z",
      sortKeywordDesc: "이름 Z-A",
      rank: "순위",
      keyword: "키워드",
      meaning: "뜻",
      freq: "총 빈도",
      ...
      markWordLabel: "키워드",
      markTypeLabel: "표시 유형",
      markPlaceholder: "표시 유형 선택",
      markContentLabel: "메모",
      markContentPlaceholder: "메모(선택 사항)…",
      markHint: "표시는 '유지보수' 탭에 집계되어 단어의 실제 업무적 의미와 추출 정확성을 판단하는 데 사용됩니다",
      markRequired: "표시 유형을 선택하거나 메모를 입력하세요",
      markContentRequired: "메모를 입력하세요",
      markSubmitted: "표시가 제출되었습니다",
      markSubmitFailed: "제출 실패. 잠시 후 다시 시도해 주세요",
      presetMeaningful: "업무적 의미 있음",
      presetNoise: "업무적 의미 없음(노이즈)",
      presetMisExtracted: "추출 부정확",
      feedbackPresetCustom: "직접 작성 / 질문…",
      emptyTitle: "핵심 키워드가 없습니다",
      emptyDesc: "문서 업로드 및 Wiki 활성화 후 키워드 페이지가 자동 생성됩니다",
      loadFailed: "불러오기 실패. 잠시 후 다시 시도해 주세요",
    },
    wikiMaintenance: {
      title: "유지보수 센터",
      totalChip: "총 {total}건",
      pendingChip: "처리 대기 {count}건",
      typeLabel: "유형",
      typeAll: "전체",
      typeQuestion: "질문",
      typeComment: "댓글",
      ...
      statusResolved: "해결됨",
      statusIgnored: "무시됨",
      searchPlaceholder: "페이지 제목 또는 slug 검색…",
      emptyTitle: "유지보수 피드백 없음",
      emptyDesc: "임의의 Wiki 페이지에서 '피드백' 버튼을 클릭해 댓글 또는 질문을 추가하세요.",
      actionResolve: "해결로 표시",
      actionReopen: "다시 열기",
      actionIgnore: "무시",
      actionDelete: "삭제",
      deleteConfirm: "이 피드백을 삭제하시겠습니까?",
    },
    buttons: {
      create: "지식베이스 생성",
      save: "설정 저장",
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: "지식베이스 전체 수명 주기를 관리할 수 있습니다: 생성, 복사, 수정, 삭제 및 초기화/설정 변경. 기존 지식베이스에 대한 작업(복사/수정/삭제)은 선택한 범위로 제한되며, 새 지식베이스 생성은 제한되지 않습니다(새 지식베이스는 이 스페이스에 속함).",
	      ...
	      capabilityManageMcpServicesHint: "MCP 서비스, 자격 증명 및 이 주체의 OAuth 상태를 관리합니다.",
