...
export default {
  ...
  agentTasks: {
    title: "任务监控",
    subtitle: "监控 WeKnora 下发到 agent-gateway 的文档「wiki 构建」任务：查看运行中与排队中的任务、重试失败任务、取消排队中或执行中的任务",
    cardsTitle: "任务概览",
    detail: {
      open: "日志",
      title: "任务执行日志",
      ...
      loadFailed: "读取执行日志失败",
      loading: "加载中…",
      noGatewayTask: "该任务没有关联的网关任务，无法查看执行日志",
      expand: "展开",
      collapse: "收起",
    },
    cards: {
    ...
    filterStatus: "按状态筛选",
    filterKeywordPlaceholder: "搜索文档名称",
    totalChip: "共 {total} 条",
    columns: {
      docName: "文档名称",
      knowledgeBase: "知识库",
    ...
    retry: "重试",
    cancel: "取消",
    cancelConfirm: "确定取消该任务吗？任务将立即停止执行。",
    refresh: "刷新",
    autoRefresh: "自动刷新",
    empty: "暂无任务",
    loadFailed: "加载任务列表失败，请稍后重试",
  ...
  mcpManage: {
    subtitle: "把 WeKnora 中配置的 MCP 服务下发到 Agent 执行端（agent-gateway），并查看网关侧生效情况与工具列表",
    newService: "新建 MCP 服务",
    refresh: "刷新",
    sync: "同步到 Agent 网关",
    syncing: "同步中…",
    syncNow: "立即同步",
    syncSuccess: "已同步 {n} 个 MCP 服务到 Agent 网关",
    syncFailed: "同步到 Agent 网关失败",
    syncSummary: "同步完成：成功 {synced} · 跳过 {skipped} · 警告 {warnings}",
    skippedTitle: "已跳过",
    warningsTitle: "警告",
    gatewayTitle: "Agent 网关状态",
    gatewayUrl: "网关地址",
    gatewaySource: "配置来源",
    sourceManaged: "托管文件（managed）",
    sourceSeed: "种子文件（seed）",
    sourceUnknown: "未知",
    reachable: "网关可达",
    unreachable: "网关不可达",
    gatewayCount: "网关已下发 {n} 个服务",
    statusError: "获取网关状态失败",
    driftTitle: "网关配置与 WeKnora 不一致",
    driftMissing: "缺少 {n} 项",
    driftExtra: "网关多出 {n} 项",
    driftMissingTip: "以下服务在 WeKnora 已启用但未下发到网关：{names}",
    driftExtraTip: "以下服务在网关存在，但 WeKnora 侧已删除或停用：{names}",
    loading: "MCP 服务列表加载中…",
    emptyTitle: "暂无 MCP 服务",
    emptyDesc: "点击右上角「新建 MCP 服务」添加第一个服务",
    colName: "名称 / 描述",
    colTransport: "传输类型",
    colTarget: "目标",
    colEnabled: "启用",
    ...
    enable: "启用",
    disable: "停用",
    enabledToast: "MCP 服务已启用",
    disabledToast: "MCP 服务已停用",
    toggleFailed: "更新 MCP 服务状态失败",
    unnamed: "未命名",
    emptyTarget: "未配置地址",
    credentialConfigured: "凭证已配置",
    credentialMissing: "凭证未配置",
    credentialTip: "仅显示密钥是否已配置，不回显明文",
    test: "测试",
    testing: "测试中…",
    testTitle: "测试结果：{name}",
    testFailed: "测试 MCP 服务失败",
    gatewayTest: "网关侧测试",
    gatewayTesting: "网关侧测试中…",
    gatewayTestTitle: "网关侧测试：{name}",
    gatewayTestFailed: "网关侧测试失败",
    gatewayOk: "网关侧连接成功",
    gatewayFailed: "网关侧连接失败",
    elapsed: "耗时 {ms} ms",
    gatewayTransport: "网关传输类型",
    toolsCount: "工具数 {n}",
    noTools: "网关未返回工具列表",
    edit: "编辑",
    delete: "删除",
    deleteConfirm: "确定删除 MCP 服务「{name}」吗？将同时从 agent-gateway 移除该服务。",
    deleted: "MCP 服务已删除",
    ...
    badgeDisabled: "未启用",
    badgeUnknown: "未知",
    tipSynced: "已下发到 agent-gateway",
    tipNotSynced: "服务已启用但尚未下发到网关，点击「同步到 Agent 网关」修复",
    tipSseUnsupported: "网关仅支持 stdio / http-streamable（streamable_http），SSE 服务会被跳过",
    tipOauthUnsupported: "OAuth 为按用户授权，网关侧无法复用该 Token，因此不会下发鉴权头",
    tipDisabled: "服务未启用，不会下发到网关（网关上的同名项会被移除）",
    tipStatusUnknown: "网关状态未知，请先点「刷新」",
    transport: {
      sse: "SSE",
  ...
  knowledgeBase: {
    ...
    zipExtractSuccess: "ZIP 解压完成，成功创建 {count} 个文件",
    zipSkippedType: "{count} 个文件格式不支持已跳过",
    zipSkippedDuplicate: "{count} 个文件已存在已跳过",
    zipSkippedOversize: "{count} 个文件超过大小限制已跳过",
    zipSkippedDepth: "{count} 个文件嵌套层级过深已跳过",
    zipSkippedCount: "{count} 个文件超出数量限制已跳过",
    zipFailed: "{count} 个文件创建失败",
    ...
    uploadFile: "上传文件",
    uploadFileDesc: "支持 PDF、Word、TXT、图片、音频、ZIP 等",
    importURL: "导入网页",
    addDocument: "添加文档",
    ...
    moveProgress: "正在移动...",
    parsingFailed: "解析失败",
    wikiBuilding: "Wiki 构建中…",
    wikiBuildFailed: "Wiki 构建失败",
    wikiBuildRetry: "重试构建",
    wikiBuildCancelled: "构建已取消",
    wikiBuildRetrySubmitted: "已重新提交构建",
    wikiBuildRetryFailed: "重试失败，请稍后再试",
  ...
  knowledgeStages: {
    ...
    subspan: {
      ...
      "multimodal.image": "多模态图像理解",
      "postprocess.summary": "内容摘要生成",
      "postprocess.question": "问题生成",
      "postprocess.graph.chunk": "知识图谱子图抽取",
      "postprocess.wiki": "Wiki 同步",
      "postprocess.wiki.extract": "Wiki 页面抽取",
      "postprocess.wiki.summary": "Wiki 摘要",
      "postprocess.wiki.classify": "Wiki 分类",
      "postprocess.wiki.page": "Wiki 页面",
      "postprocess.question.batch": "问题生成分批",
      "agent_build_start": "技能开始构建 Wiki",
      "agent_build_relations": "血缘/版本家族解析",
      "agent_build_dirs": "创建家族/版本目录",
      "agent_build_summary": "生成文档摘要",
      "agent_build_entities": "抽取实体与关键词",
      "agent_build_keywords": "抽取高频关键词",
      "agent_build_index": "重建索引与链接",
      "agent_build_done": "技能 Wiki 构建完成",
    },
    status: {
      pending: "等待中",
      running: "进行中",
  ...
  auth: {
    ...
    emailOptionalPlaceholder: "输入邮箱地址（可选）",
    userId: "用户名",
    userIdPlaceholder: "输入用户名",
    userIdRequired: "请输入用户名",
    userIdMinLength: "用户名至少2个字符",
    userIdMaxLength: "用户名不能超过50个字符",
    userIdInvalid: "用户名只能包含字母、数字、下划线和中划线",
    ...
    globalSettings: {
      ...
      sections: {
        ...
        userManagement: {
          tab: "用户管理",
          title: "用户管理",
          description: "查看所有用户、管理其工作空间成员资格，以及删除用户账户。仅系统管理员可用。",
          table: {
            username: "用户名",
            email: "邮箱",
            isSystemAdmin: "系统管理员",
          ...
          deleteUser: {
            confirmTitle: "删除用户账户",
            confirmBody: "确定永久删除用户 {username}（{email}）？此操作不可撤销，与该用户相关的所有数据将被删除。",
            confirmBtn: "删除",
            success: "用户已删除",
            failed: "删除用户失败",
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      skillLabel: "构建技能",
      skillTip: "选择用于 Wiki 构建的智能体技能（开启自定义生成时生效）",
      skillPlaceholder: "请选择构建技能（默认技能自动使用）",
      nameLabel: "知识库名称",
    ...
    wikiBrowser: {
      ...
      tabMaintenance: "维护",
      tabMaintenanceTip: "集中查看整个知识库 Wiki 上的人工评论与问题，后续可据此优化 Wiki",
      tabKeywords: "高频词",
      tabKeywordsTip: "知识库内高频词按频次降序排列，点击频次可查看详情，点击关键词可跳转",
      feedbackAddTitle: "添加评论或问题",
      feedbackDialogTitle: "添加评论 / 问题",
      feedbackPageLabel: "所属页面",
      feedbackTypeLabel: "类型",
      feedbackContentLabel: "内容",
      feedbackContentPlaceholder: "请输入你的评论或问题……",
      feedbackHint: "提交后会汇总到「维护」页，供后续优化 Wiki 时参考。",
      feedbackContentRequired: "请输入内容",
      feedbackSubmitted: "反馈已提交",
      feedbackSubmitFailed: "提交失败，请稍后重试",
      feedbackQuickTitle: "快速反馈",
      feedbackPresetContentError: "内容有误",
      feedbackPresetOutdated: "信息过时",
      feedbackPresetBrokenLink: "链接失效",
      feedbackPresetFormatIssue: "格式问题",
      feedbackPresetIncomplete: "信息不完整",
      feedbackPresetCustom: "自定义评论 / 问题…",
      feedbackPresetLabel: "快捷标记",
      feedbackPresetPlaceholder: "请选择快捷标记（可选）",
      feedbackPresetPreview: "将记录为：「{label}」",
      ...
      rootFolderLabel: "根目录",
      moveToFoldersTitle: "移动到目录",
      moveToFoldersHint: "为「{title}」选择一个或多个目标目录（可多选，一个都不选表示移动到根目录）",
      moveToFoldersAction: "移动到目录",
      moveToFoldersEmpty: "暂无目录，可先在上方新建目录",
      ...
      filterSynthesis: "综合",
      filterComparison: "对比",
      filterBusinessOntology: "业务本体",
      filterRuleOntology: "规则本体",
      filterOriginalSentence: "原文长句",
      filterFrequentKeyword: "高频关键词",
      filterTopicCluster: "主题聚类簇",
      filterKnowledgeGraphSummary: "知识图谱摘要",
      filterCrossDocumentInsight: "跨文档洞察",
      filterOriginalDocWiki: "原始文档 Wiki",
      filterClusteredKnowledgeWiki: "聚类知识 Wiki",
      viewReader: "阅读器",
      viewGraph: "图谱",
    ...
    wikiKeywords: {
      title: "高频词",
      totalChip: "共 {total} 个高频词",
      searchPlaceholder: "搜索高频词",
      sortFreqDesc: "频次降序",
      sortFreqAsc: "频次升序",
      sortKeywordAsc: "名称 A-Z",
      sortKeywordDesc: "名称 Z-A",
      rank: "排名",
      keyword: "高频词",
      meaning: "释义",
      freq: "总频次",
      ...
      markWordLabel: "高频词",
      markTypeLabel: "标注类型",
      markPlaceholder: "请选择标注类型",
      markContentLabel: "补充说明",
      markContentPlaceholder: "请输入补充说明（可选）",
      markHint: "标注将汇总到「维护」页，用于判断该词是否有实际业务含义、提取是否正确",
      markRequired: "请选择标注类型或填写说明",
      markContentRequired: "请输入补充说明",
      markSubmitted: "标注已提交",
      markSubmitFailed: "提交失败，请稍后重试",
      presetMeaningful: "有业务含义",
      presetNoise: "无业务含义（噪音）",
      presetMisExtracted: "提取不准确",
      feedbackPresetCustom: "自定义评论 / 问题…",
      emptyTitle: "暂无高频词",
      emptyDesc: "上传文档并启用 Wiki 后将自动生成高频词页面",
      loadFailed: "加载失败，请稍后重试",
    },
    wikiMaintenance: {
      title: "维护中心",
      totalChip: "共 {total} 条",
      pendingChip: "待处理 {count} 条",
      typeLabel: "类型",
      typeAll: "全部",
      typeQuestion: "问题",
      typeComment: "评论",
      ...
      statusResolved: "已解决",
      statusIgnored: "已忽略",
      searchPlaceholder: "按页面标题或 slug 搜索…",
      emptyTitle: "暂无维护反馈",
      emptyDesc: "在任意 Wiki 页面点击「反馈」按钮，即可添加评论或问题。",
      actionResolve: "标记解决",
      actionReopen: "重新打开",
      actionIgnore: "忽略",
      actionDelete: "删除",
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: "允许管理知识库全生命周期：新建、复制、修改、删除知识库并调整初始化/配置信息。针对已有知识库的操作（复制/更新/删除）仍受所选知识库范围限制；新建不受限（新知识库归本空间）。",
	      ...
	      capabilityManageMcpServicesHint: "允许管理 MCP 服务、凭据和该主体的 OAuth 授权状态。",
