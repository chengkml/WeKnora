export default {
  menu: {
    ...
    mcp: 'Управление MCP',
    agentTasks: 'Мониторинг задач агента',
    chat: 'Диалог',
  ...
  agentTasks: {
    title: 'Мониторинг задач агента',
    subtitle: 'Мониторинг задач «сборки wiki» для документов, отправляемых WeKnora в agent-gateway: просмотр выполняющихся и ожидающих задач, повтор неудачных и отмена ожидающих или выполняющихся задач',
    cardsTitle: 'Обзор задач',
    cards: {
      running: 'Выполняется',
      queued: 'В очереди',
      failedToday: 'Ошибок сегодня',
      succeededToday: 'Успешно сегодня',
    },
    ...
    filterKeywordPlaceholder: 'Поиск по имени документа',
    totalChip: 'Всего: {total}',
    columns: {
      docName: 'Документ',
      knowledgeBase: 'База знаний',
      skill: 'Навык',
    ...
    retry: 'Повторить',
    cancel: 'Отменить',
    cancelConfirm: 'Отменить эту задачу? Выполнение будет немедленно остановлено.',
    refresh: 'Обновить',
    autoRefresh: 'Автообновление',
    empty: 'Задач нет',
    loadFailed: 'Не удалось загрузить список задач, попробуйте позже',
    actionSucceeded: '{action}: успешно',
    actionFailed: '{action}: ошибка, попробуйте позже',
    duration: {
      empty: '-',
      seconds: '{n}s',
      minutes: '{m}m{s}s',
  ...
  mcpManage: {
    subtitle: 'Передайте MCP-сервисы, настроенные в WeKnora, на сторону исполнения agent-gateway и посмотрите, что реально загружено.',
    newService: 'Новый MCP-сервис',
    refresh: 'Обновить',
    sync: 'Синхронизировать с Agent Gateway',
    syncing: 'Синхронизация…',
    syncNow: 'Синхронизировать',
    syncSuccess: 'Синхронизировано MCP-сервисов: {n}',
    syncFailed: 'Не удалось синхронизировать с agent-gateway',
    syncSummary: 'Синхронизация завершена: успешно {synced} · пропущено {skipped} · предупреждений {warnings}',
    skippedTitle: 'Пропущено',
    warningsTitle: 'Предупреждения',
    gatewayTitle: 'Состояние Agent Gateway',
    gatewayUrl: 'Адрес шлюза',
    gatewaySource: 'Источник конфигурации',
    sourceManaged: 'Управляемый файл (managed)',
    sourceSeed: 'Файл-заготовка (seed)',
    sourceUnknown: 'Неизвестно',
    reachable: 'Доступен',
    unreachable: 'Недоступен',
    gatewayCount: 'На шлюзе загружено сервисов: {n}',
    statusError: 'Не удалось получить состояние шлюза',
    driftTitle: 'Конфигурация шлюза отличается от WeKnora',
    driftMissing: 'не хватает {n}',
    driftExtra: 'лишних на шлюзе: {n}',
    driftMissingTip: 'Включены в WeKnora, но отсутствуют на шлюзе: {names}',
    driftExtraTip: 'Есть на шлюзе, но удалены или отключены в WeKnora: {names}',
    loading: 'Загрузка MCP-сервисов…',
    emptyTitle: 'MCP-сервисов нет',
    emptyDesc: 'Нажмите «Новый MCP-сервис» справа сверху, чтобы добавить первый сервис.',
    colName: 'Имя / описание',
    colTransport: 'Транспорт',
    colTarget: 'Назначение',
    colEnabled: 'Включён',
    colGateway: 'Синхр. со шлюзом',
    colActions: 'Действия',
    enabled: 'Включён',
    disabled: 'Отключён',
    enable: 'Включить',
    disable: 'Отключить',
    enabledToast: 'MCP-сервис включён',
    disabledToast: 'MCP-сервис отключён',
    toggleFailed: 'Не удалось изменить состояние MCP-сервиса',
    unnamed: 'Без имени',
    emptyTarget: 'Адрес не задан',
    credentialConfigured: 'Учётные данные заданы',
    credentialMissing: 'Учётные данные отсутствуют',
    credentialTip: 'Показывается только наличие секрета, открытый текст не выводится.',
    test: 'Проверить',
    testing: 'Проверка…',
    testTitle: 'Результат проверки: {name}',
    testFailed: 'Не удалось проверить MCP-сервис',
    gatewayTest: 'Проверка на шлюзе',
    gatewayTesting: 'Проверка на шлюзе…',
    gatewayTestTitle: 'Проверка на шлюзе: {name}',
    gatewayTestFailed: 'Проверка на шлюзе не удалась',
    gatewayOk: 'Соединение через шлюз успешно',
    gatewayFailed: 'Соединение через шлюз не удалось',
    elapsed: 'заняло {ms} мс',
    gatewayTransport: 'Транспорт шлюза',
    toolsCount: 'инструментов: {n}',
    noTools: 'Шлюз не вернул список инструментов',
    edit: 'Изменить',
    delete: 'Удалить',
    deleteConfirm: 'Удалить MCP-сервис «{name}»? Он также будет удалён из agent-gateway.',
    deleted: 'MCP-сервис удалён',
    deleteFailed: 'Не удалось удалить MCP-сервис',
    badgeSynced: 'Синхронизирован',
    badgeNotSynced: 'Не синхронизирован',
    badgeUnsupported: 'Не поддерживается',
    badgeDisabled: 'Отключён',
    badgeUnknown: 'Неизвестно',
    tipSynced: 'Уже передано в agent-gateway',
    tipNotSynced: 'Сервис включён, но ещё не на шлюзе — нажмите «Синхронизировать с Agent Gateway».',
    tipSseUnsupported: 'Шлюз поддерживает только stdio / http-streamable (streamable_http); сервисы SSE пропускаются.',
    tipOauthUnsupported: 'OAuth выдаётся на пользователя, шлюз не может переиспользовать токен — заголовок авторизации не передаётся.',
    tipDisabled: 'Сервис отключён и не передаётся на шлюз (одноимённая запись на шлюзе будет удалена).',
    tipStatusUnknown: 'Состояние шлюза неизвестно — сначала нажмите «Обновить».',
    transport: {
      sse: 'SSE',
  ...
  knowledgeBase: {
    ...
    zipExtractSuccess: 'ZIP распакован, создано файлов: {count}',
    zipSkippedType: '{count} файл(ов) пропущено (неподдерживаемый формат)',
    zipSkippedDuplicate: '{count} файл(ов) пропущено (уже существует)',
    zipSkippedOversize: '{count} файл(ов) пропущено (превышен размер)',
    zipSkippedDepth: '{count} файл(ов) пропущено (слишком глубокая вложенность)',
    zipSkippedCount: '{count} файл(ов) пропущено (превышен лимит количества)',
    zipFailed: '{count} файл(ов) не удалось создать',
    ...
    uploadFileDesc: 'Поддерживает PDF, Word, TXT, изображения, аудио, ZIP и т.д.',
    ...
    wikiBuilding: 'Построение Wiki…',
    wikiBuildFailed: 'Не удалось построить Wiki',
    wikiBuildRetry: 'Повторить построение',
    wikiBuildCancelled: 'Построение отменено',
    wikiBuildRetrySubmitted: 'Построение переотправлено',
    wikiBuildRetryFailed: 'Не удалось повторить. Попробуйте позже',
  ...
  knowledgeStages: {
    ...
    subspan: {
      'embedding.embed': 'Векторное эмбеддинг',
      'multimodal.image': 'Распознавание изображений',
      'postprocess.summary': 'Создание сводки',
      'postprocess.question': 'Генерация вопросов',
      'postprocess.graph.chunk': 'Извлечение графа знаний',
      'postprocess.wiki': 'Синхронизация Wiki',
      'postprocess.wiki.extract': 'Извлечение страниц Wiki',
      'postprocess.wiki.summary': 'Сводка Wiki',
      'postprocess.wiki.classify': 'Классификация Wiki',
      'postprocess.wiki.page': 'Страница Wiki',
      'postprocess.question.batch': 'Пакетная генерация вопросов',
      'agent_build_start': 'Начало сборки Wiki навыком',
      'agent_build_relations': 'Разбор родов/версий',
      'agent_build_dirs': 'Создание каталогов семейства/версий',
      'agent_build_summary': 'Генерация сводки документа',
      'agent_build_entities': 'Извлечение сущностей и ключевых слов',
      'agent_build_keywords': 'Извлечение частотных ключевых слов',
      'agent_build_index': 'Перестроение индекса и ссылок',
      'agent_build_done': 'Сборка Wiki навыком завершена',
    },
    status: {
      pending: 'Ожидание',
      running: 'Выполняется',
      ...
      skipped: 'Пропущено',
      cancelled: 'Отменено',
      agent_running: 'Парсинг готов, навык ещё работает',
      agent_failed: 'Сборка навыком не удалась',
      agent_cancelled: 'Навык отменён',
    },
    agent: {
      title: 'Сборка Wiki навыком',
      total: 'Всего {d}',
      noLogs: 'Журналов прогресса навыка пока нет',
      status: {
        queued: 'Навык в очереди',
        running: 'Навык работает',
        succeeded: 'Навык завершён',
        failed: 'Навык не удался',
        cancelled: 'Навык отменён',
      },
    },
    errorCode: {
...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      skillLabel: 'Навык сборки',
      skillTip: 'Выберите навык агента для построения Wiki (действует при включенной ручной генерации)',
      skillPlaceholder: 'Выберите навык сборки (по умолчанию — стандартный навык)',
    ...
    wikiBrowser: {
      ...
      tabMaintenanceTip: 'Просматривайте все ручные комментарии и вопросы по Wiki данной БЗ — они помогут в дальнейшей оптимизации Wiki.',
      tabKeywords: 'Ключевые слова',
      tabKeywordsTip: 'Ключевые слова БЗ по частоте, нажмите для просмотра страницы слова',
      feedbackAddTitle: 'Добавить комментарий или вопрос',
      feedbackDialogTitle: 'Добавить комментарий / вопрос',
      feedbackPageLabel: 'Страница',
      feedbackTypeLabel: 'Тип',
      feedbackContentLabel: 'Содержание',
      feedbackContentPlaceholder: 'Введите ваш комментарий или вопрос…',
      feedbackHint: 'Отправленные элементы собираются во вкладке «Обслуживание» для последующей оптимизации Wiki.',
      feedbackContentRequired: 'Введите содержание',
      feedbackSubmitted: 'Отзыв отправлен',
      feedbackSubmitFailed: 'Не удалось отправить. Повторите попытку позже',
      feedbackQuickTitle: 'Быстрый отзыв',
      feedbackPresetContentError: 'Ошибка в содержании',
      feedbackPresetOutdated: 'Устаревшая информация',
      feedbackPresetBrokenLink: 'Битая ссылка',
      feedbackPresetFormatIssue: 'Проблема с оформлением',
      feedbackPresetIncomplete: 'Неполная информация',
      feedbackPresetCustom: 'Свой комментарий / вопрос…',
      feedbackPresetLabel: 'Быстрая отметка',
      feedbackPresetPlaceholder: 'Выберите быструю отметку (необязательно)',
      feedbackPresetPreview: 'Будет записано как: «{label}»',
      ...
      moveToFoldersTitle: 'Переместить в каталоги',
      moveToFoldersHint: 'Выберите один или несколько каталогов для «{title}» (если не выбрано — переместить в корень)',
      moveToFoldersAction: 'Переместить в каталоги',
      moveToFoldersEmpty: 'Каталогов пока нет — сначала создайте каталог',
    ...
    wikiKeywords: {
      ...
      totalChip: 'Ключевых слов: {total}',
      searchPlaceholder: 'Поиск ключевых слов',
      sortFreqDesc: 'Частота: по убыванию',
      sortFreqAsc: 'Частота: по возрастанию',
      sortKeywordAsc: 'Название А-Я',
      sortKeywordDesc: 'Название Я-А',
      rank: 'Место',
      keyword: 'Ключевое слово',
      meaning: 'Значение',
      freq: 'Общая частота',
      docCount: 'Документы',
      freqViewTip: 'Подробнее',
      drawerEmpty: 'Нет содержимого',
      markColumn: 'Отметка',
      markAction: 'Отметить',
      markTitle: 'Оценка слова',
      markWordLabel: 'Слово',
      markTypeLabel: 'Тип отметки',
      markPlaceholder: 'Выберите тип отметки',
      markContentLabel: 'Примечание',
      markContentPlaceholder: 'Примечание (необязательно)…',
      markHint: 'Отметки собираются во вкладке «Обслуживание» для оценки бизнес-смысла слова и корректности извлечения',
      markRequired: 'Выберите тип отметки или напишите примечание',
      markContentRequired: 'Введите примечание',
      markSubmitted: 'Отметка отправлена',
      markSubmitFailed: 'Не удалось отправить. Повторите попытку позже',
      presetMeaningful: 'Имеет бизнес-смысл',
      presetNoise: 'Нет бизнес-смысла (шум)',
      presetMisExtracted: 'Извлечено неверно',
      feedbackPresetCustom: 'Свой комментарий / вопрос…',
      emptyTitle: 'Пока нет ключевых слов',
      emptyDesc: 'Страницы ключевых слов создаются автоматически после загрузки документов и включения Wiki',
      loadFailed: 'Не удалось загрузить. Повторите попытку позже',
    },
    wikiMaintenance: {
      title: 'Центр обслуживания',
      totalChip: 'Всего {total}',
      pendingChip: 'Ожидает {count}',
      typeLabel: 'Тип',
      typeAll: 'Все',
      typeQuestion: 'Вопрос',
      ...
      statusIgnored: 'Игнорировано',
      searchPlaceholder: 'Поиск по названию страницы или slug…',
      emptyTitle: 'Пока нет отзывов',
      emptyDesc: 'Нажмите кнопку «Отзыв» на любой странице Wiki, чтобы добавить комментарий или вопрос.',
      actionResolve: 'Отметить решённым',
